...
public class methods {
    ...
    double[][] getdistances(char[][] inarr,String corrmet, treemakethread parent){
    ...
    double[][] getdistances(aaseq[] inarr,String corrmet,treemakethread parent){
